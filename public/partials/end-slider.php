...
?>
    ...
    <?php if( count($bl_slides) > 1 ): ?>
    <!-- Controls -->
    <a class="left carousel-control" href="#carousel-<?php echo count($bl_sliders_printed); ?>" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="#carousel-<?php echo count($bl_sliders_printed); ?>" role="button" data-slide="next">
