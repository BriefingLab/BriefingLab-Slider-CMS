...
class Bl_Slider_Cms_Manager {
    ...
    public function __construct() {
        ...
        $this->plugin_slug = 'bl-slider-cms';
        $this->version = '1.0.0';
        $this->options = array(
            'bl-slider-custom-template-folder' => 'bl-custom-templates'
        ); // now fixed
    ...
    private function load_dependencies() {
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bl-slider-cms-model.php';
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bl-slider-cms-theme-functions.php';
...
/**
    ...
    private function define_public_hooks() {
        ...
        Bl_Slider_Cms_Theme_Functions::define_theme_functions();
